'''
python inference.py \
  --model /mnt/workspace/kennethliu/ckpt/qwen2_5vl-7b_dual_rehearsal_2/stage2/checkpoint-155 \
  --image /mnt/workspace/kennethliu/bin/color_test_512.png \
  --prompt "圖中TFT的顏色是甚麼" \
...
python inference.py \
  --model /mnt/workspace/kennethliu/ckpt/qwen2_5vl-7b_dual_rehearsal_2/stage1b/checkpoint-2000 \
